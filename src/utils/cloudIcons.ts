...
export const SurroundingIcon = `${cloudPath}/surroundings.svg`;
export const PreferenceIcon = `${cloudPath}/preference.svg`;
...
export const PurpleUpArrow = `${cloudPath}/purple-up-arrow.svg`;
