...
const Index = () => {
  ...
  const demoData: HouseItemProps = {
    house: {
      id: '63cb1eba65fc8fd3054d82f30ac0a2d2',
      capacity: 1,
      description: '女',
      ...
      images: [
        ...
        // 'https://media.self.com/photos/630635c30b7f36ce816f374a/4:3/w_960,c_limit/DAB03919-10470989.jpg',
        // 'https://thumbor.forbes.com/thumbor/fit-in/1290x/https://www.forbes.com/advisor/wp-content/uploads/2022/10/condo-vs-apartment.jpeg.jpg',
      ],
      xhsContact: '418467603',
    },
  };

  useEffect(() => {
    setHouseDetail(demoData);
  }, []);
