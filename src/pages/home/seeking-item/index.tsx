    ...
    return (
        <View className="seeking">
            ...
            <View className="seeking-content">
                <View>
                    <Image src={seekingItem.avatar} style={{ width: '60px', height: '60px', 'marginRight': '20px' }}/>
                </View>
                <View className="seeking-text">
                    ...
                    <View>
                        <Image src={DateIcon} style={{ width: '20px', height: '20px', 'marginRight': '5px' }}/>
                    <Text>{seekingItem.start_date} to {seekingItem.end_date}</Text>
                    </View>
                </View>
            </View>
            </View>
