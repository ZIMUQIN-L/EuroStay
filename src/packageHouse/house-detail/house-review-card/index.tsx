...
import { KeyArrowLeft, DefaultAvatar } from '@utils/cloudIcons';
    ...
    <>
      <View className='reviews-container'>
        <View className='container-title'>
          ...
          >
            <View className='container-recommend-times'>
              推荐次数{house.recommendedTimes}
            </View>
            {ratingInfo?.length === 0 ? '暂无评价' : '查看更多'}
            <Image src={KeyArrowLeft} className='right-bottom-arrow' />
          </View>
        </View>
        <View
              ...
              <View className='review-card'>
                <View className='review-card-top'>
                  ...
                  <View className='review-card-top-right'>
                    <View className='review-ratings'>推荐</View>
                    {/* todo */}
